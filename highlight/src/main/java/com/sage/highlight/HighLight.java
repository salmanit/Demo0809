...
import com.sage.highlight.util.ViewUtils;
import com.sage.highlight.view.HightLightView;
...
public class HighLight
{
    public static class ViewPosInfo
    {
        ...
        public int shape;/**0默认的矩形，1圆形或椭圆*/
    }
    ...
    {
       return addHighLight(viewId,0,decorLayoutId,onPosCallback);
    }
    public HighLight addHighLight(int viewId, int shape, int decorLayoutId, OnPosCallback onPosCallback)
    {
        ViewGroup parent = (ViewGroup) mAnchor;
        View view = parent.findViewById(viewId);
        addHighLight(view,shape, decorLayoutId, onPosCallback);
        return this;
    }
...
//            if (!rect.equals(viewPosInfo.rectF))
            {
    ...
    public HighLight addHighLight(View view,int decorLayoutId, OnPosCallback onPosCallback){
        return  addHighLight(view,0,decorLayoutId,onPosCallback);
    }

    public HighLight addHighLight(View view, int shape, int decorLayoutId, OnPosCallback onPosCallback)
    {
        ViewGroup parent = (ViewGroup) mAnchor;
